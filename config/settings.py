...
env = environ.Env(
    ...
    OLLAMA_MODEL=(str, "qwen2.5:7b"),  # free local scoring; 7B is ~2x faster than 14B, good enough
    OLLAMA_TIMEOUT=(int, 120),  # a local model can take tens of seconds per job
    OLLAMA_KEEP_ALIVE=(str, "30m"),  # keep the model in RAM between jobs (no cold reload)
    VOYAGE_API_KEY=(str, ""),
    GITHUB_TOKEN=(str, ""),
    GITHUB_USER=(str, ""),
